import ProductFilter from "../../components/shoppingPage/filter";
...
function ShoppingListing() {
  ...
  function handleFilter(section, option) {
    ...
    if (!updatedFilters[section]) {
      updatedFilters[section] = [option];
    } else {
      const idx = updatedFilters[section].indexOf(option);
      if (idx === -1) updatedFilters[section].push(option);
      else updatedFilters[section].splice(idx, 1);
    }
