...
import AdminProductTile from "../../components/adminPage/product-title";
  ...
  return (
    <Fragment>
      <div className="mb-5 w-full flex justify-end ">
        <Button className='bg-rose-800 text-white hover:bg-rose-700 ' onClick={() => setOpenCreateProductsDialog(true)}>Add New Product</Button>
      </div>
